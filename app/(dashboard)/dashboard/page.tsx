 ...
 * Início
 *
 * Números do mês, gráfico de 7 dias, atividade recente e atalhos. É a tela que
 * responde "está funcionando?" antes de qualquer outra coisa.
 */
...
/** Atalhos para o que se faz de fato depois de olhar os números. */
const quickActions: { label: string; hint: string; href: string }[] = [
  {
    label: "Nova automação",
    hint: "Comentário ou DM com palavra-chave",
    href: "/campaigns/new",
  },
  {
    label: "Ver contatos",
    hint: "Quem já recebeu o quê",
    href: "/contacts",
  },
  {
    label: "Caixa de entrada",
    hint: "Responder à mão",
    href: "/inbox",
  },
  {
    label: "Registros",
    hint: "Por que não enviou",
    href: "/logs",
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-1 panel rounded p-4 sm:p-6">
          <h2 className="text-sm font-semibold text-foreground mb-4">
            Palavras-chave que mais disparam
          </h2>
          <div className="space-y-3">
            {stats?.topKeywords.length === 0 && (
              <p className="text-sm text-muted py-8">
                Nenhuma palavra-chave disparou ainda
              </p>
            )}
