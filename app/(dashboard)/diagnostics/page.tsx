...
/** Chaves de contagem do BullMQ, com nome legível. */
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            Saúde do worker, fila, falhas de webhook e alertas operacionais.
          </p>
        </div>
        <button
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title="Falhas e pulos de DM por automação">
          {data?.dmFailures.length ? (
            ...
            <EmptyState label="Nenhuma falha nem pulo de DM." />
          )}
        </Section>
        ...
        <Section title="Falhas de webhook">
          {data?.webhookFailures.length ? (
            ...
            <EmptyState label="Nenhum webhook falhou." />
          )}
        </Section>
      </div>

      <div className="grid gap-6 lg:grid-cols-2">
        <Section title="Falhas ao renovar o token">
