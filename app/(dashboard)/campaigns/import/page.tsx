...
export default function ImportCampaignsPage() {
  ...
  function startImport() {
    ...
    if (parsed.length === 0) {
      setError("Cole um CSV com a linha de cabeçalho e pelo menos uma automação.");
      return;
    }
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted mt-1">
          Cole um CSV com uma linha por automação. Cada linha abre no construtor
          já preenchida e editável, para você revisar e escolher o reel antes de
          salvar. Colunas obrigatórias:{" "}
          ...
          vão numa célula só, separadas por vírgula. Use{" "}
