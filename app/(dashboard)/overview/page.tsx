    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0">
          <h1 className="text-lg font-semibold text-foreground">Análise</h1>
          <p className="text-sm text-muted mt-1">
            {data.requestedCount === "all" ? "Desde o início" : "Recentes"} —{" "}
      ...
      {!insightsAvailable && (
        <div className="panel rounded p-4 border border-border">
          <p className="text-sm text-foreground">
            Visualizações, alcance, salvamentos e compartilhamentos precisam da
            permissão de insights.
          </p>
          <p className="text-sm text-muted mt-1">
            Reconecte a conta para liberar — até lá, curtidas e comentários
